<template>
  <div class="addtional__file">
    <vs-popup button-accept="false" button-cancel="false" :active.sync="isActive" :title="$t('mode.EditReferenceNumber')">
...
export default {
  ...
  methods: {
    ...mapActions('invoice', {
      updateRefferenceInvoice: 'updateRefferenceInvoice'
    }),
    async saveRefNumber() {
      ...
      this.$store
        .dispatch('invoice/updateRefferenceInvoice', {
          id: this.refNumberId,
          data: {
            ...this.form
          }
